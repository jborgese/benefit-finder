...
interface Section8ExplanationProps {
  programName: string;
...
const getSection8BenefitInfo = (t: (key: string) => string, userProfile?: Section8ExplanationProps['userProfile']): string[] => {
  const benefits = [
    ...
    t('results.section8.benefits.portability'),
    t('results.section8.benefits.fairMarketRent'),
    t('results.section8.benefits.utilities'),
  ];

  if (userProfile?.isElderly) {
    benefits.push(t('results.section8.benefits.elderly'));
  }
  if (userProfile?.isDisabled) {
    benefits.push(t('results.section8.benefits.disability'));
  }
  if (userProfile?.hasChildren) {
    benefits.push(t('results.section8.benefits.families'));
  }
...
const getSection8RequirementsExplanation = (t: (key: string) => string): string[] => {
  return [
    ...
    t('results.section8.requirements.housingNeed'),
    t('results.section8.requirements.familyComposition'),
    t('results.section8.requirements.backgroundCheck'),
    t('results.section8.requirements.cooperation'),
  ];
};
...
const getSection8NextSteps = (t: (key: string) => string): string[] => {
  return [
    ...
    t('results.section8.nextSteps.documentation'),
    t('results.section8.nextSteps.interview'),
    t('results.section8.nextSteps.voucher'),
  ];
};
...
const getSection8HowToApply = (t: (key: string) => string): string[] => {
  return [
    ...
    t('results.section8.howToApply.step3'),
    t('results.section8.howToApply.step4'),
    t('results.section8.howToApply.step5'),
  ];
};
...
const getSection8Resources = (t: (key: string) => string): string[] => {
  return [
    ...
    t('results.section8.resources.localOffice'),
    t('results.section8.resources.housingAuthority'),
  ];
};
...
export const Section8Explanation: React.FC<Section8ExplanationProps> = ({
  ...
  const statusMessage = getSection8StatusMessage(status, t);
  const benefits = getSection8BenefitInfo(t, userProfile);
  const requirements = getSection8RequirementsExplanation(t);
  const nextSteps = getSection8NextSteps(t);
  const howToApplySteps = getSection8HowToApply(t);
  const resources = getSection8Resources(t);
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-6">
        <h4 className="font-semibold text-gray-900 mb-3 flex items-center">
          ...
          {t('results.section8.benefits.title')}
        </h4>
      ...
      <div className="mb-6">
        <h4 className="font-semibold text-gray-900 mb-3 flex items-center">
          <span className="text-lg mr-2">📋</span>
          {t('results.section8.requirements.title')}
        </h4>
        <ul className="space-y-2">
      ...
      <div className="mb-6">
        <h4 className="font-semibold text-gray-900 mb-3 flex items-center">
          <span className="text-lg mr-2">📞</span>
          {t('results.section8.nextSteps.title')}
        </h4>
        <ul className="space-y-2">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <h4 className="font-semibold text-blue-900 mb-2 flex items-center">
          <span className="text-lg mr-2">🏠</span>
          {t('results.section8.howToApply.title')}
        </h4>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
        <h4 className="font-semibold text-gray-900 mb-2 flex items-center">
          ...
          {t('results.section8.resources.title')}
        </h4>
