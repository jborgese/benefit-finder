/**
 * Mobile State Selector Component
 */

import React from 'react';
import type { StateSelectorCommonProps } from './selectorProps';
import { LocationDetectionUI } from './LocationDetectionUI';
import { renderStateListContent } from './utils';

export const MobileStateSelector: React.FC<StateSelectorCommonProps> = (props) => {
  const {
