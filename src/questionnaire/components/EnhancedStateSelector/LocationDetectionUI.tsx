/**
 * Location Detection UI Component
 *
 * Displays location detection status, errors, and actions
 */

import React from 'react';

interface LocationDetectionUIProps {
...
export const LocationDetectionUI: React.FC<LocationDetectionUIProps> = ({
  showLocationButton,
  isLocationLoading,
